...
package  org.jasig.portlet.properties;
...
public class PropertiesManager {
    ...
    public static final String CONFIG_PROPERTIES_FILE_SYSTEM_VARIABLE = "configration.properties";
    private static final String CONFIG_PROPERTIES_FILE_NAME = "/properties/configuration.properties";
    ...
    protected static void loadProps() {
        ...
        try {
            String pfile = System.getProperty(CONFIG_PROPERTIES_FILE_SYSTEM_VARIABLE);
            if (pfile == null) {
                pfile = CONFIG_PROPERTIES_FILE_NAME;
            }
